...
*/
  ...
  NetDeviceContainer rhLteDevs =lteHelper->InstallUeDevice (remoteHost);
  ...
  Ipv4AddressHelper ipv4h;
  ipv4h.SetBase ("1.0.0.0", "255.0.0.0");
  Ipv4InterfaceContainer internetIpIfaces = ipv4h.Assign (rhLteDevs);
  ...
  //internetIpIfaces = address.Assign (ueLteDevs);
